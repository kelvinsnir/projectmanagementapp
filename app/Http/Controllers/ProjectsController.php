...
class ProjectsController extends Controller
{
        ...
        if(Auth::user()->id == $project->user_id)
            {
               ...
               $projectUser = ProjectUser::where('user_id', $user->id)
                ...
                if($projectUser){
                    ...
                    ->with('success', $request->input('email').' is already a member');
                }
    ...
    {
        //save data
        $projectUpdate = Project::where('id', $project->id)->update(['name'=>$request->input('name'), 'description'=>$request->input('description')]);
